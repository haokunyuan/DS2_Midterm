...
### import data 
```{r}
raw_df_train = read_csv("data/walmart-recruiting-store-sales-forecasting/train.csv")

raw_df_stores = read_csv("data/walmart-recruiting-store-sales-forecasting/stores.csv")


raw_df_ftrs = read_csv("data/walmart-recruiting-store-sales-forecasting/features.csv")
...
ggplot(aes(x = Size, y = Weekly_Sales),data = df_merged) +
  geom_point()

ggplot(aes(x = Fuel_Price, y = log(Weekly_Sales)),data = df_merged) +
